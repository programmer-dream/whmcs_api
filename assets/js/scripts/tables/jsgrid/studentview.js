...
$(document).ready(function () {
  ...
  function populateGrid(courseId, moduleId) {
    $("#jsGridStudent").jsGrid({
      width: "100%",
      filtering: true,
      editing: false,
      inserting: false,
    ...
    $("#jsGridStudent :input").keydown(function () {
      var self = this;
      if (self.timeout) {
  ...
  $('#module').on('change',function(){
      ...
      if(courseId && moduleId){
        populateGrid(courseId, moduleId);
      }
      $("#jsGridStudent").show();
  })
