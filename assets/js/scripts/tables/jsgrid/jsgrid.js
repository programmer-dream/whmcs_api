    ...
    ******************************/
    ...
    $("#sorting-table").jsGrid({
        ...
        fields: [
            ...
            { name: "Module_Year", type: "number", width: 50 },
            { name: "Domain", type: "text", width: 200 },
            { name: "Module", type: "select", items: db.countries, valueField: "Id", textField: "Name" },
    ...
    ************************/
    ...
    $("#validation").jsGrid({
        ...
        fields: [
            ...
            { name: "Module_Year", type: "number", width: 50, validate: { validator: "range", param: [18, 80] } },
            { name: "Domain", type: "text", width: 200, validate: { validator: "rangeLength", param: [10, 250] } },
            {
                name: "Module", type: "select", items: db.countries, valueField: "Id", textField: "Name",
                validate: { message: "Module should be specified", validator: function (value) { return value > 0; } }
            },
            { name: "Married", type: "checkbox", title: "Is Married", sorting: false },
            { type: "control" }
        ]
