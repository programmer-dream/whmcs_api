...
function student() {
    ...
    if(is_valid){
        var settings= {
            ...
            dataType: "json",
            url: "/api/student",
            data: {module:value1,teaching_block_period:teaching_block_period,teaching_location:teaching_location,ID:ID},
...
function staff() {
    ...
    if(is_valid){
        ...
        var settings= {
            ...
            dataType: "json",
            url: "/api/staff",
            data: {name:"staff", module:value1, teaching_block_period:teaching_block_period,teaching_location:teaching_location,ID:ID},
            success: function(response) {
                //response.data contains whatever is sent from server
