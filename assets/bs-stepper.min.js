...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var inputPasswordForm = document.getElementById('example-dropright')
...
function student() {
    var isCourseEnabled = $('#isCourseEnabled').val()
    
    if(isCourseEnabled == '1'){
        var value= []
        $(".moduleCheckced").each(function(){
            if($(this).is(":checked")){
                value.push($(this).val());
            }
        });
        ...
        var value=$("#example-dropright").val();
        
    }
    
    var value1=JSON.stringify( value )
    console.log(value1, "<< value1")
    var teaching_block_period = $("#teaching_block_period").val()
    var teaching_location = $("#teaching_location").val()
    var ID = $("#ID").val()
    var is_valid = $("#form2").valid();
    //console.log(value1, "<< module")
    //console.log(is_valid,"<<< staff")
    if(is_valid){
        var settings= {
            type: "POST",
            dataType: "json",
            url: "/api/student",
            data: {module:value1,teaching_block_intake_id:teaching_block_period,teaching_location:teaching_location,ID:ID},
...
function staff() {
    ...
    if(is_valid){
        ...
        var settings= {
            ...
            dataType: "json",
            url: "/api/staff",
            data: {name:"staff", module:value1, teaching_block_intake_id:teaching_block_period,teaching_location:teaching_location,ID:ID},
            success: function(response) {
                //response.data contains whatever is sent from server
